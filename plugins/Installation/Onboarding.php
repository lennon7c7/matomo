...
<br>
Thank you for installing On-Premises, the #1 Google Analytics alternative that protects your data.<br>
<br>
You’re receiving this email from your instance because you\'re the Super User and you have just finished installing On-Premise. You’re the only person who will receive this email. The mail was sent from your Matomo.<br>
<br>
It’s now our job to ensure you get the best possible experience without any disruptions, so we hope to answer the three most common problems we find users ask when starting out with Matomo.<br>
<br>
<strong>1. Speed up your by generating your reports in the background</strong><br>
...
<a href="' . Url::addCampaignParametersToMatomoLink('https://matomo.org/docs/requirements/#recommended-servers-sizing-cpu-ram-disks') . '">&gt;&gt; Learn the recommended server configuration and sizing to run with speed</a><br>
<br>
<strong>3. Next, make sure your data is secure</strong><br>
Privacy and security are of utmost importance to the team and we want to make sure security is up to the standard you need.<br>
Below is a link that will give your administrator a list of tips and best practices to improve security.<br>
...
<br>
It’s so great to have you be part of the community! We hope to deliver you the valuable insights you need to make better data-driven decisions for your website.<br>
<br>
Happy Analytics,<br>
<br>
Matthieu<br>
