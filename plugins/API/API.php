...
class API extends \Piwik\Plugin\API
{
    ...
    public function getReportMetadata(
        ...
        if (empty($idSite) && !empty($idSites)) {
            ...
            throw new \Exception('Calling API.getReportMetadata without any idSite is no longer supported since 3.0.0. Please specify at least one idSite via the "idSite" parameter.');
        }
