...
class Manager extends \ArrayObject
{
    ...
    public function getTable($idTable)
    {
        if (!isset($this[$idTable])) {
            throw new TableNotFoundException(sprintf("Error: table id %s not found in memory. (If this error is causing you problems in production, please report it in issue tracker.)", $idTable));
        }
